...
van deze voertuigdata worden uitgelezen, waaronder gegevens over het motortoerental, 
de voertuigsnelheid, temperaturen en de belasting van de motor. 
Deze gegevens kunnen worden gebruikt voor diagnose, analyse en het
...
Door beide communicatiemethoden onder vergelijkbare omstandigheden te testen,
wordt nagegaan welke methode het meest geschikt is voor het doorsturen van
realtime voertuigdata.
...
Daarnaast kunnen uitschieters in latency en de werkelijk behaalde
updatefrequentie inzicht geven in de prestaties van beide
...
\begin{itemize}
    ...
    van gemiddelde latency, P95-latency en netwerkverbruik bij
    update-intervallen van 100, 250 en 1000 milliseconden?

    \item In welke mate worden de ingestelde updatefrequenties bij REST API en
    WebSockets in de praktijk behaald?
...
gemiddelde latency, P95-latency, werkelijk behaalde updatefrequentie en het
netwerkverbruik gemeten en met elkaar vergeleken.
...
bij verschillende update-intervallen en geëvalueerd op basis van gemiddelde
latency, P95-latency, werkelijk behaalde updatefrequentie en netwerkverbruik.

In Hoofdstuk~\ref{ch:testing-en-evaluatie-van-het-systeem} wordt het volledige systeem getest en geëvalueerd. 
Hierbij wordt nagegaan of de verschillende onderdelen correct samenwerken en worden de belangrijkste 
beperkingen van de ontwikkelde oplossing besproken.
...
bevindingen worden samengevat, de beperkingen van het onderzoek worden
besproken en er worden mogelijkheden voor toekomstig onderzoek voorgesteld.